...
def writeTunnelRules(p4info_helper, ingress_sw, egress_sw, tunnel_id,dst_eth_addr, dst_ip_addr):
    ...
    """
    table_entry = p4info_helper.buildTableEntry(
        table_name="MyIngress.CacheTable",
        match_fields={
            "hdr.myTunnel.dst_id": tunnel_id
        },
        action_name="MyIngress.CacheTable",
        action_params={
            "dstAddr": dst_eth_addr,
            "port": 1
        })
...
def readTableRules(p4info_helper, sw):
    ...
    for response in sw.ReadTableEntries():
        for entity in response.entities:
            ...
            # TODO For extra credit, you can use the p4info_helper to translate the IDs in the entry to names
...
def main(p4info_file_path, bmv2_file_path):
    ...
    try:
        ...
        s2 = p4runtime_lib.bmv2.Bmv2SwitchConnection(
            ...
            device_id=1,
            proto_dump_file='../logs/control_plaine_s2-p4runtime-requests.txt')
        s3 = p4runtime_lib.bmv2.Bmv2SwitchConnection(
            name='s3',
            address='127.0.0.1:50053',
            device_id=2,
            proto_dump_file='../logs/control_plaine_s3-p4runtime-requests.txt')
        ...
        print("Configured Additional set of rules in S2 and S3")
        ...
        # Write the rules that tunnel traffic -- THIS IS THE WANTED TABLES
        ...
        # TODO Uncomment the following two lines to read table entries from s2 and s3
...
if __name__ == '__main__':
    ...
    parser.add_argument('--p4info', help='p4info proto in text format from p4c',
                        ...
                        default='./basic_tunnel.p4.p4info.txt')
    parser.add_argument('--bmv2-json', help='BMv2 JSON file from p4c',
                        type=str, action="store", required=False,
                        default='./basic_tunnel.json')
